...
namespace System.Runtime.ConversionServices
{
    ...
    {
        ITypedReference Add<T1, T2>(T1 a, T2 b);
        ITypedReference AddUnchecked<T1, T2>(T1 a, T2 b);
    }
    ...
    public interface IGenericArithmetic : IGeneric
    {
        ...
        IGenericArithmetic Op<TOther, IOpType>(ArithmeticTest<TOther> other);
    }
    ...
    public struct ArithmeticTest<T> : IGenericArithmetic
    {
        ...
        public IGenericArithmetic Op<TOther, IOpType>(ArithmeticTest<TOther> other)
        {
            return Op<TOther, T, IOpType>.Call(other.Value, this.Value);
        }
        public ICallable ResolveCall<TOther>(ArithmeticTest<TOther> other)
        {
    ...
    public class ArithmeticFactory
    {
        ...
        {
            Op<int, int, IAdd>.Call = (a, b) => new ArithmeticTest<int> { Value = a + b };
            Op<int, int, IAddUnchecked>.Call = (a, b) => new ArithmeticTest<int> { Value = unchecked(a + b) };
