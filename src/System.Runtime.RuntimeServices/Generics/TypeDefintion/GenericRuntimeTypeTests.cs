...
namespace System.Runtime.RuntimeServices
{
    public class GenericRuntimeTypeTests
    {
        ...
        public static void ExplicitInterfaceExtenstionTests()
        {
            ...
            var numeric = newFromType.As().Numeric;// <- this is okay I think.
            var numericPlus1 = numeric.Add(1);
            var numericPlus2 = numeric.Add<long>(2);
        ...
        public static void TestGenericTypeDefinition()
        {
            ...
            a = ea.AsNumeric().Add(b).To<sbyte>().AsNumeric();
